                                        ...
                                        <div class="col col-caixa-servico">
                                            ...
                                            <?php }else{ ?>
                                                ...
                                                if(isset($btnAtualizar)){ ?>
                                                    <script>location.href='controller/Controller.php?funcao=atualizarPedidoFuncionario&funcaoAtualizarPedido=confirmadoPeloFuncionario&dataEnvio=<?php echo $_POST['txtDataEnvio']; ?>&mensagemFuncionario=<?php echo $_POST['txtMensagemFuncionario']; ?>&idServico=<?php echo $_POST['idServico']; ?>'</script>
                                                <?php }elseif(isset($btnCancelar)){ ?>
                                                    <script>location.href='controller/Controller.php?funcao=atualizarPedidoFuncionario&funcaoAtualizarPedido=canceladoPeloFuncionario&dataEnvio=<?php echo $_POST['txtDataEnvio']; ?>&mensagemFuncionario=<?php echo $_POST['txtMensagemFuncionario']; ?>&idServico=<?php echo $_POST['idServico']; ?>'</script>
                                                <?php  }
