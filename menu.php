    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <div class="d-btn">
               ...
               <?php }else{ //aparecer conta caso ele esteja logado ?>
                        <li class="nav-item dropdown">
    ...
    <div class="offcanvas-body" style="background: #002060;">
        <div class=" navbar-dark">
            <?php if(isset($_SESSION['logado'])){ ?>
                <a class="navbar-brand logo-menu-celular-conta" href="conta.php ">
                    <?php if($_SESSION['imgConta'] == NULL){ //caso o usuario nao tenha uma imagem de conta, mostrar somente a primeira letra do nome ?>
                        <div class="img-conta-letra-menu-cel"><?php echo $_SESSION['nome'][0]  //mostra primeira letra do nome na imagem da conta ?></div>
                    <?php }else{ //caso o usuario tenha uma imagem de conta mostrar a mesma ?>
                        <img src="img/imgConta/<?php echo $_SESSION['imgConta']; ?>" class="img-conta-menu-cel" height="200" width="200">
                    <?php } ?>
                </a>
            <?php  }else{ ?>
            ...
            <?php if(isset($_SESSION['logado'])){  ?>
                ...
                <li class="nav-item">
                    <a href="controller/Controller.php?funcao=sair" class="nav-link nav-login-cel" href="dicas.php">Sair</a>
                </li>
            <?php } ?>
        <?php if(!$_SESSION['logado']){  //aparecer botao para entrar e para cadastrar caso ele nao esteja logado ?>
